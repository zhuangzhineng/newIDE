    ...
    init: function() {
      ...
      a[h] = function(n, s, o) {
        ...
        if (l === "fixed") {
          ...
          var m = e.createElement("img"),
              p = j.size.toLowerCase(),
              q,
              k;
          switch (j.type) {
            case "personal":
      ...
      i.ready(function() {
        ...
        var m = k[0],
            r = i.getRealWarpNode(m),
            q = top.location.href.split("#")[0].split("?")[0],
            q = q.replace(/(https?:\/\/)([^\.]+\.[^\.\/]+\/)/, "$1www.$2/$3"),
            o = i._AQ_outer + "/query_auth_status/?callback=" + h + "&url=" + q + s;
